...
![Version](https://img.shields.io/badge/Version-5.0.12-red.svg)
...
dependencies {
    implementation "dev.lightdream:lambda:5.0.12"
    implementation "com.github.L1ghtDream:lambda:5.0.12"
}
```
