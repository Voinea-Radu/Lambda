...
![Version](https://img.shields.io/badge/Version-4.1.16-red.svg)
...
dependencies {
    implementation "dev.lightdream:lambda:4.1.16"
    implementation "com.github.L1ghtDream:lambda:4.1.16"
}
```
