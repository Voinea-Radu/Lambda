...
![Version](https://img.shields.io/badge/Version-4.1.10-red.svg)
...
dependencies {
    implementation "dev.lightdream:lambda:4.1.10"
    implementation "com.github.L1ghtDream:lambda:4.1.10"
}
```
